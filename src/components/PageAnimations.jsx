...
const animations = [
  ...
  { trigger: '.packs', targets: '.packs-header, .pack-card, .packs-inclusion', y: 34, stagger: 0.1 },
  { trigger: '.packs-showcase', targets: '.packs-showcase-header, .pack-photo, .brands', y: 32, stagger: 0.12 },
